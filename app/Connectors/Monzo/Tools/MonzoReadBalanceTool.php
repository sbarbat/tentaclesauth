...
#[Title('Read Monzo Account Balance')]
class MonzoReadBalanceTool extends ConnectorTool
{
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            'account_id' => $schema->string()
                ->description('The ID of the Monzo account to fetch the balance for. You can obtain this ID by using the "List Monzo Accounts" tool.')
                ->required(),
        ];
    }
